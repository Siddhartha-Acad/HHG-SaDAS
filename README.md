...
<img src="z_doc_figures/H@C60_evo.gif" alt="HHG-SaDAS evolution animation" align="right" width="320" style="border-radius: 10px;" />
...
<p align="center">
<img src="z_doc_figures/f0_H1s@C60_rasterized_contourf_evolution_chart.svg" alt="Evolution Chart" width="900"/>
</p>
<p align="center" style="margin-top:-2mm;">
Figure 3: Time evolution of the single-atom response for H(1s)@C<sub>60</sub> (Full animation: <a href="https://youtu.be/-iOrwTjOPM0" target="_blank" rel="noopener noreferrer">YouTube</a>).
</p>
...
> 
> **`check_GPSM.py`** takes information about the atom (free or confined) and other settings from `parameters.py`, and independently solves the **time-independent Schrödinger equation** using GPSM while visualizing the results through various plots, including different sets of eigenvectors (both collectively and individually).
>
