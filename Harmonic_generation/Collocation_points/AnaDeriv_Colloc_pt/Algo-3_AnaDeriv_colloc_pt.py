...
if __name__ == '__main__':
    ...
    fig = plt.figure(); ax1 = fig.add_subplot(111); da.decorate_2d(ax1)
    ...
    if len(colloc_pt) == N - 1:
        if not Write_PN:
            ...
            np.savetxt(txt_file_name, colloc_pt, fmt='%20.15f', header=header, comments='')
        else:
            ...
            np.savetxt(txt_file_name, colloc_pt_and_PN, fmt='%20.15f', header=header, comments='')
